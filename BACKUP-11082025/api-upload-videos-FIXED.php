<?php
// BACKUP DEL ARCHIVO CORREGIDO - 11/08/2025
// PROBLEMA RESUELTO: Eliminada función getVideoDuration() duplicada 
// que causaba error fatal: "Cannot redeclare getVideoDuration()"
...
try {
    ...
    for ($i = 0; $i < $fileCount; $i++) {
        ...
        if (move_uploaded_file($tmpName, $targetPath)) {
            try {
                // Obtener duración del video (función en config/config.php)
